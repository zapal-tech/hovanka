...
const prices = [
  997.56, 944.34, 972.25, 832.4, 888.76, 834.8, 805.56, 767.38, 861.21, 669.6, 694.39, 721.32, 694.03, 610.1, 502.2, 549.56,
  611.03, 583.4, 610.14, 660.6, 752.11, 721.19, 638.89, 661.7, 694.51, 580.3, 638.0, 613.3, 651.64, 560.51, 611.45, 670.68,
  752.56,
]
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-green-500">Tailwind Labs, Inc.</div>
            <div className="text-sm text-green-900">$CSS</div>
          ...
          <div className="mt-3 border-t border-green-200 pt-5">
            <div className="flex items-baseline gap-2">
              <div className="text-2xl tabular-nums tracking-tight text-green-900">{activeValue.toFixed(2)}</div>
              <div className="text-sm text-green-900">USD</div>
              {percentageChange && (
                <div
                  className={clsx(
                    'ml-auto text-sm tabular-nums tracking-tight',
                    percentageChange >= 0 ? 'text-cyan-500' : 'text-green-500',
                  )}
                >
            ...
            <div className="mt-6 flex gap-4 text-xs text-green-500">
              <div>1D</div>
              <div>5D</div>
            ...
            <div className="mt-3 rounded-lg bg-green-50 ring-1 ring-inset ring-black/5">
              <Chart
                width={286}
                height={208}
                paddingX={16}
            ...
            <div className="mt-4 rounded-lg bg-cyan-500 px-4 py-2 text-center text-sm font-semibold text-white">Trade</div>
            <div className="mt-3 divide-y divide-green-100 text-sm">
              <div className="flex justify-between py-1">
                <div className="text-green-500">Open</div>
                <div className="font-medium text-green-900">6,387.55</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-green-500">Closed</div>
                <div className="font-medium text-green-900">6,487.09</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-green-500">Low</div>
                <div className="font-medium text-green-900">6,322.01</div>
              </div>
            </div>
          </div>
        </div>
