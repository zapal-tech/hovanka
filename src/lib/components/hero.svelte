<script lang="ts">
  ...
  import logoFastCompany from '$lib/assets/logos/fast-company.svg'
  import logoForbes from '$lib/assets/logos/forbes.svg'
  import logoHuffPost from '$lib/assets/logos/huffpost.svg'
  import logoTechCrunch from '$lib/assets/logos/techcrunch.svg'
  import logoWired from '$lib/assets/logos/wired.svg'
  import * as m from '$lib/paraglide/messages'

  // import AppDemo from './app-demo.svelte'
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
      ...
      <div class="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
        <BackgroundIllustration
          class="absolute left-1/2 top-4 h-[1026px] w-[1026px] -translate-x-1/3 stroke-green-300/70 mask-image sm:top-16 sm:-translate-x-1/2 lg:-top-16 lg:ml-12 xl:-top-14 xl:ml-0"
        />
        <div
          class="-mx-4 h-[448px] px-9 mask-image sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32"
        >
      ...
      <div class="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6 select-none opacity-0" style="opacity: 0;">
