    ...
    <section id="secondary-features" aria-label="Features for building a portfolio" className="py-20 sm:py-32">
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-medium tracking-tight text-green-900">Now is the time to build your portfolio.</h2>
          <p className="mt-2 text-lg text-green-600">
            With typical market returns, you have to start young to secure your future. With Pocket, it’s never too late to build
            your nest egg.
          </p>
        </div>
        <ul
        ...
        >
          {features.map((feature) => (
            <li key={feature.name} className="rounded-2xl border border-green-200 p-8">
              <feature.icon className="h-8 w-8" />
              <h3 className="mt-6 font-semibold text-green-900">{feature.name}</h3>
